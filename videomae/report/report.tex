...
\midrule
\textit{Ours:} & & & & & & & \\
\quad Supervised (s$=$42)                  & 7.72 & 0.106 & 0.033 & 0.178 & 0.123 & 3.60 & 0.086 \\
\quad Supervised (s$=$43)                  & 7.72 & \textbf{0.098} & \textbf{0.033} & \textbf{0.164} & \textbf{0.078} & 3.32 & 0.088 \\
...
\quad VideoMAE / SimMIM, mask$=0.90$       & 8.07 & 0.253 & 0.111 & 0.395 & 0.465 & 7.75 & 0.042 \\
...
\paragraph{(3) Seed stability.} Two supervised seeds (s$=42$, s$=43$) give
linear MSE $0.106$ and $0.098$ respectively (mean $0.102$, std $\sim$$0.005$),
and CKA $0.97$ between them: the supervised baseline is highly reproducible.
The VideoMAE encoders across mask ratios have CKA $\geq 0.97$ with each other,
but only $0.72$--$0.75$ with the supervised encoder, confirming that the SSL
objective is the dominant representation-shaping variable -- not the seed and
not the mask ratio.
