...
This approach is retained as a collapse-mitigation ablation. It is not the selected final run in this repository because the CNext-U-Net forecaster produced the best downstream validation and test results under the project deadline.
